...
const links = [
  ...
  { href: "/#flash", label: "Flash", hash: "#flash" },
...
export function SiteHeader() {
  ...
  function isActive(href: string, linkHash?: string) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border bg-surface/95 shadow-[0_1px_0_0_rgba(230,200,74,0.18)] backdrop-blur">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between gap-4 px-4">
        <a href="/#home" className="truncate text-sm font-semibold tracking-wide text-ink">
          Geovane Ink
        </a>
            ...
            link.hash ? (
              <a
                ...
                className={cn(
                  ...
                  isActive(link.href, link.hash) ? "text-primary" : "text-muted",
                )}
              >
                {link.label}
              </a>
